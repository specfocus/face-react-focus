 ...
 *
 * Use the useEditContext() hook to read the context. That's what the Edit components do in @specfocus/view-focus.mui-demo.
 *
 * @example
 *
 * import { useEditController, EditContextProvider } from '@specfocus/view-focus';
 *
 * const Edit = props => {
