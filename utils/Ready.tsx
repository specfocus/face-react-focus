    ...
    <div style={styles.root}>
      <div style={styles.main}>
        <img
          ...
          alt="@specfocus/view-focus.mui-demo logo"
        />
      ...
      <div style={styles.secondary}>
        <Button
          href="https://marmelab.com/@specfocus/view-focus.mui-demo/Readme.html"
        ...
        />
        <Button
          href="https://github.com/marmelab/@specfocus/view-focus.mui-demo/tree/master/examples"
        ...
        />
        <Button
          href="https://stackoverflow.com/questions/tagged/@specfocus/view-focus.mui-demo"
