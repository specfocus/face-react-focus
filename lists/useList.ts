 ...
 * @param {Entity[]} props.data An array of records
 ...
 */
export const useList = <RecordType extends Entity = any>(
...
export interface UseListOptions<RecordType extends Entity = any> {
  data?: RecordType[];
  error?: any;
