...
import queryReducer, {
  HIDE_FILTER, SET_FILTER, SET_PAGE,
  SET_PER_PAGE,
  SET_SORT, SHOW_FILTER, SORT_ASC
} from './queryReducer';
 ...
 *      resource: 'posts',
 *      location: location // From react-router. Injected to your component by @specfocus/view-focus.mui-demo inside a List
 *      filterDefaultValues: {
 *          published: true
 *      },
 *      sort: {
