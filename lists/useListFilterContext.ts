...
export const useListFilterContext = (props?: any): ListFilterContextValue => {
  ...
  if (!context.hideFilter) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      console.log(
        "List components must be used inside a <ListContextProvider>. Relying on props rather than context to get List data and callbacks is deprecated and won't be supported in the next major version of @specfocus/view-focus.mui-demo."
      );
    }
    return props;
  }
