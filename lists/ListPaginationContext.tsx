 ...
 * That's what List components do in @specfocus/view-focus.mui-demo (e.g. <Pagination>).
 *
 ...
 * @example
 *
 * import { useListController, ListPaginationContext } from '@specfocus/view-focus';
 *
 * const List = props => {
